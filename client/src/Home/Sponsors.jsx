  ...
  return (
    <section className={`premium-sponsors-section reveal ${isVisible ? 'visible' : ''}`} ref={ref}>
      <div className="sponsors-header">
        <span className="sponsors-subtitle">Proudly supported by industry</span>
        <h2 className="sponsors-title">Our Sponsor</h2>
      ...
      >
        ...
        <div className="sponsors-marquee-wrapper">
          <div 
            ref={sliderRef}
            className={`sponsors-slider-container${sponsorsData.length === 1 ? ' single-sponsor' : ''}`}
          ...
          >
            {sponsorsData.map((item, index) => (
              <a key={index} href={item.href} target="_blank" rel="noreferrer" className="premium-sponsor-card">
