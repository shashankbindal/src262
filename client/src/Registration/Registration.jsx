            ...
            <>
              ...
              <div className="reg-gate-fees">
                <div className="reg-gate-fee-card">
                  ...
                  <span className="rg-fee-val">₹{(config?.feeBase ?? 4000).toLocaleString('en-IN')}</span>
                  <span className="rg-fee-desc">Access to all conference events</span>
                </div>
                <div className="reg-gate-fee-card">
                  <span className="rg-fee-type">Registration + Fooding</span>
                  <span className="rg-fee-val">₹{(config?.feeFooding ?? 6000).toLocaleString('en-IN')}</span>
                ...
                <div className="reg-gate-fee-card highlighted">
                  ...
                  <span className="rg-fee-val">₹{(config?.feeWithAccommodation ?? 6500).toLocaleString('en-IN')}</span>
